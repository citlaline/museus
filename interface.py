...
with col3:
   st.image_2("https://assets.masp.org.br/uploads/temp/WEB_JB_MASP_10811_01.jpg", width=100)
   if st.button_2('Clique aqui'):
      st.write_2('Imagem selecionada')

with col4:
   st.image_3("https://assets.masp.org.br/uploads/temp/WEB_JB_MASP_10808_01.jpg", width=100)
   if st.button_3('Clique aqui'):
      st.write_3('Imagem selecionada')

with col5:
   st.image_4("https://assets.masp.org.br/uploads/temp/WEB_JB_MASP_10802_01.jpg", width=100)
